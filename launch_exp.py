...
idx_set_words, embed, model_trained, losses = model.launch_train(X_train, Y_train, words_set, we, taille_embedding, taille_context=3, bidirectional=False, num_layers=1, nb_epoch=10, targset_size=1, device=device, is_trained=is_trained)
if is_trained:
